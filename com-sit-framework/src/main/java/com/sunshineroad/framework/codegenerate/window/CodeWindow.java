...
/*     */ 
/*  40 */   String[] planets = { "uuid", "identity", "sequence" };
/*     */ 
/*     */   public CodeWindow() {
...
/*  50 */     final JTextField packagefld = new JTextField("tfunciton");
/*  51 */   final  JLabel entitylbl = new JLabel("实体类名（首字母大写）：");
/*  52 */ final    JTextField entityfld = new JTextField("Tfunction");
/*  53 */  final   JLabel tablejbl = new JLabel("表名：");
/*  54 */  final   JTextField tablefld = new JTextField("t_s_function");
/*     */ 
...
/*     */     {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (!"".equals(entityfld.getText())) {
        CodeWindow.entityName = StringUtils.capitalise(entityfld.getText());
      ...
      try
      {
        boolean tableexist = new SitReadTable().checkTableExist(CodeWindow.tableName);
        if (tableexist)
        {
 ...
 * Qualified Name:     org.jeecgframework.codegenerate.window.CodeWindow
