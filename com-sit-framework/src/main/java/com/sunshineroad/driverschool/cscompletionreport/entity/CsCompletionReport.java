package com.sunshineroad.driverschool.cscompletionreport.entity;
 ...
 * @Description: 完工报告
 * @author  
 * @date 2014-01-15 11:57:34
 * @version V1.0   
 *
 */
@Entity
@Table(name = "CS_COMPLETION_REPORT", schema = "")
public class CsCompletionReport extends BaseEntity {
	/**id*/
	...
	@SequenceGenerator(name="sequence",sequenceName="CS_COMPLETION_REPORT_seq",allocationSize=1)
	 ...
	 */
	@Column(name ="REPORT_NUMBER",nullable=true,length=50)
