...
public class CsContractDetailInfo extends BaseEntity {
	...
	@SequenceGenerator(name="sequence",sequenceName="CS_CONTRACT_DETAIL_INFO_seq",allocationSize=1)
	@Column(name ="ID",nullable=true,precision=32,scale=0)
	 ...
	 */
	@Column(name ="EQUIPMENT_PRICE",nullable=false,precision=20,scale=8)
	 ...
	 */
	@Column(name ="REMARK15",nullable=true,precision=20,scale=8)
	 ...
	 */
	@Column(name ="REMARK16",nullable=true,precision=20,scale=8)
	 ...
	 */
	@Column(name ="REMARK17",nullable=true,precision=20,scale=8)
	 ...
	 */
	@Column(name ="REMARK18",nullable=true,precision=20,scale=8)
