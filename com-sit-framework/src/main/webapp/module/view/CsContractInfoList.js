...
Ext.define('Fes.view.CsContractInfoList', {
    ...
    createStore: function() {
        ...
        function(store, options) {
            var params = {
                paramsArea: Ext.getCmp('csContractInfoList' + 'areaQ').getValue(),
    ...
    exportExcel: function() { // 导出EXCEL报表
        ...
        var vExportContent = getExcelUrl.getExcelUrl(me, "更新日志");
