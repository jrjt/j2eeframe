...
createRoleCombox:function(){
	...
	{xtype : 'rownumberer'}, 
					...
					{text : '合同编号/销单编号/签证编号',width : 120,sortable : true,dataIndex : 'contractName',field : {xtype : 'textfield',required : true}},
					...
					{text : '项目编号',width : 120,sortable : true,dataIndex : 'signDate',field : {xtype : 'textfield',required : true}},
					{text : '签订时间',width : 120,sortable : true,dataIndex : 'endDate',field : {xtype : 'textfield',required : true}},
