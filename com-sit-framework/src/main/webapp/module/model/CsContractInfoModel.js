Ext.define("Fes.model.CsContractInfoModel",{
	...
	fields:[
			...
			{name:'firstPaymoneyDate',type:'string'}	,	//首付款回款时间
			
			{name:'secondPaymoney',type:'string'}	,	//第二笔金额
			
			{name:'secondPaymoneyDate',type:'string'}	,	//第二笔回款时间
			
			{name:'endPaymoney',type:'string'}	,	//尾款金额
			
			{name:'endPaymoneyDate',type:'string'}	,	//尾款回款时间
			
			{name:'otherPaymoney',type:'string'}	,	//其他回款金额
			
			{name:'otherPaymoneyDate',type:'string'}	,	//其他回款时间
