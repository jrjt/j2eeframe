/**
 * @class SimpleReports.controller.Tasks
 * @extends Ext.app.Controller
 */
Ext.define('SimpleReports.controller.Tasks', {
        ...
        me.control(
            {
                ...
                'taskGrid': {
                    ...
                    sqlclick: me.handleSqlIconClick,
    ...
    newTask: function() {
        var me = this,
            ...
            task = Ext.create('SimpleReports.model.Task');
    ...
    handleSqlIconClick: function(view, rowIndex, colIndex, column, e) {
        this.showSqlWindow(view.getRecord(view.findTargetByEvent(e)));
    },
     ...
     * @param {SimpleReports.model.Task[]} tasks
     */
     ...
     * @param {SimpleReports.view.Toolbar} toolbar
     */
     ...
     * @param {SimpleReports.model.Task} task       the task to edit
     */
...
hideSqlWindow: function(button, e) {
    ...
    getDefaultReminderTime: function(callback, timeFormat) {
        ...
        if(me.defaultReminderTime) {
            ...
            if (SimpleReportsSettings.useLocalStorage) {
                defaultReminderTime = localStorage.getItem('SimpleReports-defaultReminderTime');
    ...
    saveDefaultTime: function(button, e) {
        ...
        if (SimpleReportsSettings.useLocalStorage) {
            localStorage.setItem('SimpleReports-defaultReminderTime', time);
